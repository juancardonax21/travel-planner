...
export default function TripNav({ trip, active }: { trip: Trip; active: string }) {
  ...
  return (
    <>
      {/* Fixed header wrapper — no overflow-hidden here */}
      <div className="fixed top-0 left-0 right-0 z-30 shadow-lg">
        {/* Inner with overflow-hidden for the background image */}
